...
module.exports.run = async (bot,message,args) => {
  ...
  message.delete();
  if (u.lvl < 5) return message.channel.send('Неа, давай ка сам UwU')
  if (args[0] == `<@!763735590029361182>`) return message.channel.send('Всмысле сам себя я должен кусать? @_@')
  let embed = new Discord.MessageEmbed()
  .setDescription(`${bot.user.username} кусает ${args[0]}. Кусь!`)
  .setColor("#eeff00")
